...
var priceSort1 = document.querySelector(".pricesort1")
priceSort1.addEventListener("click", function () {
    domainList.sort((a, b) => {
        return a.price - b.price
    })
    rightdom.innerHTML = ""
...
//  anbanit sortireba domainextensionis mixedvit
var alphabet=document.querySelector(".sp90")
alphabet.addEventListener("click",function(){
     
      domainList.sort((a, b) => {
        return a.domainExtension.localeCompare(b.domainExtension)
    })
    rightdom.innerHTML = ""
   tmp()   
})

var sp99=document.querySelector(".sp99")
sp99.addEventListener("click",function(){
...
// ----------------------------------------es aris scori akamde
var but_search = document.querySelector(".but_search")  
but_search.addEventListener("click", function () {  
    rightdom.innerHTML=""
    for (var i of domainList) { 
        if ((inp2.value <= i.price && inp11.value >= i.price)&&(inp21.value <= i.domainExtension.length && inp111.value >= i.domainExtension.length)) {
            console.log("xomagiikomase")
            var tmp = `  
    <div class="maincard" >
    <div class="nameandphoto">
    <img src="icon/dropicon.svg" alt="" class="xc">
